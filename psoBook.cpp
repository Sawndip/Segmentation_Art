...
//////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////
//// PsoBookcode class method
int PsoBookcode :: processFrame(const cv::Mat & in, cv::Mat & out)
{
...
int PsoBookcode :: refineNetsByCollectiveWisdom(const vector<double> & p, cv::Mat & out)
{
...
PsoBookcode :: PsoBookcode(const int width, const int height)
    : m_imgWidth(width)
    , m_imgHeight(height)
    , m_inputFrames(0)
